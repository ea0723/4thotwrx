class ConversionsController < ApplicationController
  ...
  def edit
    @conversion = Conversion.find(set_conversion)
  end
  ...
  def create
    ...
    respond_to do |format|
      if @conversion.save
        format.html { redirect_to @conversion, notice: "Conversion Successful" }
  ...
  def destroy
    @conversion.destroy
    respond_to do |format|
      format.html { redirect_to conversions_url, notice: 'Conversion was successfully removed.' }
  ...
  def conversion_params
    params.require(:conversion).permit(:convert_me, :credits)
  end
end
